...
public class TestDb extends AndroidTestCase {
    ...
    public void testCreateDb() throws Throwable {
        ...
        c = db.rawQuery("PRAGMA table_info(" + com.example.android.sunshine.app.data.WeatherContract.LocationEntry.TABLE_NAME + ")", null);
    ...
    */
    public void testLocationTable() {
        ...
        WeatherDbHelper weatherDbHelper = new WeatherDbHelper(this.getContext());
        SQLiteDatabase db = weatherDbHelper.getWritableDatabase();
        // Insert ContentValues into database and get a row ID back
        long id = this.insertLocation();
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("ERROR: returned data is different from original", cursor, TestUtilities.createNorthPoleLocationValues());
        assertFalse("ERROR: more records where found!", cursor.moveToNext());
    ...
    public void testWeatherTable() {
        ...
        long idLocation = this.insertLocation();
        // First step: Get reference to writable database
        SQLiteDatabase db = new WeatherDbHelper(this.getContext()).getWritableDatabase();

        // Create ContentValues of what you want to insert
        // (you can use the createWeatherValues TestUtilities function if you wish)
        ContentValues contentValues = TestUtilities.createWeatherValues(idLocation);

        // Insert ContentValues into database and get a row ID back
        long idWeather = db.insert(WeatherContract.WeatherEntry.TABLE_NAME, null, contentValues);

        // Query the database and receive a Cursor back
        Cursor cursor = db.query(WeatherContract.WeatherEntry.TABLE_NAME, null, null, null, null, null, null);

        // Move the cursor to a valid database row
        assertTrue("ERROR: there was no records found in the database", cursor.moveToFirst());
